...
function Landing(props) {
    ...
    return (
        <Container fluid style={{backgroundColor: "black", color:"white", paddingTop:"12vh", paddingBottom: "12vh"}}>
                {/* <Stack>
                    <div>
                ...
                <Stack direction="horizontal" gap={3} style={{ overflowX: "auto", }}>
                    <Stack><Image src="assets/ministries/coin.png" alt="" style={{ width: "6vh" }} roundedCircle />Finance</Stack>
                    <Stack><Image src="assets/ministries/health.png" alt="" style={{ width: "6vh" }} roundedCircle />Health</Stack>
                    <Stack><Image src="assets/ministries/education.png" alt="" style={{ width: "6vh" }} roundedCircle />Educational</Stack>
                    <Stack><Image src="assets/ministries/Agric.png" alt="" style={{ width: "6vh" }} roundedCircle />Agriculture</Stack>
                    <Stack><Image src="assets/ministries/Energy.png" alt="" style={{ width: "6vh" }} roundedCircle />Energy</Stack>
                    {/* <Stack><Image src="assets/ministries/home.png" alt="" style={{ width: "6vh" }} roundedCircle />Home Affairs</Stack> */}
                    <Stack><Image src="assets/ministries/Tour.png" alt="" style={{ width: "6vh" }} roundedCircle />Tourism</Stack>
                    <Stack><Image src="assets/ministries/lands.png" alt="" style={{ width: "6vh" }} roundedCircle />lands</Stack>
                    <Stack><Image src="assets/ministries/Justice.png" alt="" style={{ width: "6vh" }} roundedCircle />Justice</Stack>
                ...
                <Row>
                    <Col style={{ height: " 45vh", marginBottom: "5%", padding: "0 0" }}>
